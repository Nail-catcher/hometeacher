                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="class_child" type="number" min="1" max="11" class="form-control{{ $errors->has('class_child') ? ' is-invalid' : '' }}" name="class_child" value="{{ old('class_child') }}" required autofocus>
